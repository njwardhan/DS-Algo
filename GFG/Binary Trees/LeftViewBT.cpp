...
// Recursive Approach: O(N) time and O(height of tree) space
// For level order approach, this problem gave a TLE lol :/
...
void Traversal(Node* root, vector<int>& answer, int level)
{
    if(root == NULL)
        return;
